				...
				if msg["type"]=="Text" and not msg.get("message_id") in answered:
					if not sleeped:
						if hasAds(msg.get("text")) and not msg.get("author_object_guid") in admins :
							...
							try:
								bot.sendMessage(target, "https://rubika.ir/joing/FAAAICF0YXRKPXZHEHRTEARQORCHZZXX", message_id=msg.get("message_id"))
							except:
								print("err CheKhabar")		
							...
							try:
								bot.sendMessage(target, "بابامو چیکار داری؟😂", message_id=msg.get("message_id"))
							except:
								print("err poker answer")		
